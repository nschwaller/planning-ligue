...
namespace plannning_ligue
{
    class Seance
    {
        ...
        public void ajout(string ChoixJour, DateTime JourDebut, DateTime JourFin, string HeureD, string MinuteD, string HeureF, string MinuteF, string Type, string desc)
        {
            Sql Unnom = new Sql();
